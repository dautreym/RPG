...
def Procedure_attaque(attaquant,degats,cible):
    ...
    if(cible.immortalite<=0):
        ...
        if(cible.tours_sommeil>0):
            ...
            cible.Peut_jouer=1
        if (attaquant.perturbation_recup<=0):
            attaquant=Monstre.etreSoigne(attaquant,Arrondir(attaquant.vol_de_vie*degats/100))
    else:
...
class HerosBouclier(Monstre):
    def __init__(self):
        Monstre.__init__(self,'Héros du Bouclier','la Destruction',3,1,2250,2250,64,150,100)
        
        self.pv_min_3=2250
        self.attaque_min_3=64
        self.defense_min_3=150
        self.pv_min_4=3375
        self.attaque_min_4=96
        self.defense_min_4=204
        self.pv_min_5=4500
        self.attaque_min_5=128
        self.defense_min_5=287
        self.pv_min_6=6345
        self.attaque_min_6=160
        self.defense_min_6=387 # reste 81 - (87 - 54) = 48 et 48*15 = 720 
        
        self.pv_max_3=3915
        self.attaque_max_3=132
        self.defense_max_3=240 # reste 108 et 108 / 3 = 36 et 36*15 = 540
        self.pv_max_4=6375
        self.attaque_max_4=161
        self.defense_max_4=388
        self.pv_max_5=8745
        self.attaque_max_5=190
        self.defense_max_5=538
        self.pv_max_6=11090
        self.attaque_max_6=254
        self.defense_max_6=688 # reste 1647 - 1574 = 73 après le + 363 et 73 * 15 = 1095

        self.regeneration=0.01
        
        self.nb_capacites=2
        
        self.capacite1=HerosBouclier.Poing
        self.capacite1Nom='Coup de Poing'
        self.capacite1BonusSkill=0
        self.Trecharge1=1
        self.attente1=0
        self.etatCap1='dispo'
        
        self.capacite2=HerosBouclier.Bouclier
        self.capacite2Nom='Coup de Bouclier'
        self.capacite2BonusSkill=0
        self.Trecharge2=1
        self.attente2=0
        self.etatCap2='dispo'

    # 1 comme coefficient multiplicateur et pas 4 
    def Poing(hb,cible):
        print('\n',hb.surnom,hb.attribut,' frappe ',cible.surnom,cible.attribut,' d\'un coup de poing plein de colère!!\n')
        degats=CalculDommage(hb,4,hb.capacite1BonusSkill,cible)
        AffichageTypeDeCoup(hb,4,hb.capacite1BonusSkill,degats,cible)
        degats=ReductionDommage(degats,cible)
        Procedure_attaque(hb,degats,cible)
        if(cible.immunite<=0):
            EffetNefaste=random.randint(1,100)
            Limite_reussite=CalculTauxReussiteEffet(0.15,cible.resistance_actuelle,hb.precision_actuelle)
            if(EffetNefaste<=100*Limite_reussite):
                print(cible.nom,cible.attribut,' est étourdi(e)!! \n')
                cible.stun=1
        return cible
        
    def Bouclier(hb,cible):
        print('\n',hb.surnom,hb.attribut,' frappe ',cible.surnom,cible.attribut,' avec son bouclier en découvrant sa garde!!\n')
        degats=hb.defense+CalculDommage(hb,4,hb.capacite1BonusSkill,cible)
        AffichageTypeDeCoup(hb,4,hb.capacite1BonusSkill,degats-hb.defense,cible)
        degats=ReductionDommage(degats,cible)
        Procedure_attaque(hb,degats,cible)
        if(cible.immunite<=0):
            EffetNefaste=random.randint(1,100)
            Limite_reussite=CalculTauxReussiteEffet(0.5,cible.resistance_actuelle,hb.precision_actuelle)
            if(EffetNefaste<=100*Limite_reussite):
                Atk_break(cible,1)
        Def_break(hb,1)
        return cible
...
class HeroineSceptre(Monstre):
    def __init__(self):
        Monstre.__init__(self,'Héroïne du Sceptre','la Lumière Divine',3,1,2250,2250,150,64,100)
        
        self.pv_min_3=2250
        self.attaque_min_3=150
        self.defense_min_3=64
        self.pv_min_4=3375
        self.attaque_min_4=204
        self.defense_min_4=96
        self.pv_min_5=4500
        self.attaque_min_5=287
        self.defense_min_5=128
        self.pv_min_6=6345
        self.attaque_min_6=387
        self.defense_min_6=160
        
        self.pv_max_3=3915
        self.attaque_max_3=240
        self.defense_max_3=132
        self.pv_max_4=6375
        self.attaque_max_4=388
        self.defense_max_4=161
        self.pv_max_5=8745
        self.attaque_max_5=538
        self.defense_max_5=190
        self.pv_max_6=11090
        self.attaque_max_6=688
        self.defense_max_6=254

        self.vol_de_vie=10
        
        self.nb_capacites=3
        
        self.capacite1=HeroineSceptre.Flamme
        self.capacite1Nom='Flamme'
        self.capacite1BonusSkill=0
        self.Trecharge1=1
        self.attente1=0
        self.etatCap1='dispo'
        
        self.capacite2=HeroineSceptre.Glace
        self.capacite2Nom='Glace'
        self.capacite2BonusSkill=0
        self.Trecharge2=1
        self.attente2=0
        self.etatCap2='dispo'
        
        self.capacite3=HeroineSceptre.Tornade
    ...
    def Flamme(hs,cible):
        print('\n',hs.surnom,hs.attribut,' incinère ',cible.surnom,cible.attribut,' avec une boule de feu!!\n')
        degats=CalculDommage(hs,4,hs.capacite1BonusSkill,cible)
        AffichageTypeDeCoup(hs,4,hs.capacite1BonusSkill,degats,cible)
        if(cible.attribut=='Vent'):
            degats+=degats
        degats=ReductionDommage(degats,cible)
        Procedure_attaque(hs,degats,cible)
        if(cible.immunite<=0):
            EffetNefaste=random.randint(1,100)
            Limite_reussite=CalculTauxReussiteEffet(0.15,cible.resistance_actuelle,hs.precision_actuelle)
            if(EffetNefaste<=100*Limite_reussite):
                Degats_continus(cible,1,1)
        return cible
        
    def Glace(hs,cible):
        print('\n',hs.surnom,hs.attribut,' perfore ',cible.surnom,cible.attribut,' avec un pieux de glace!!\n')
        degats=CalculDommage(hs,4,hs.capacite1BonusSkill,cible)
        AffichageTypeDeCoup(hs,4,hs.capacite1BonusSkill,degats,cible)
    ...
    def Tornade(hs,cible):
        print('\n',hs.surnom,hs.attribut,' balaye ',cible.surnom,cible.attribut,' avec une petite tornade!!\n')
        degats=CalculDommage(hs,4,hs.capacite1BonusSkill,cible)
        AffichageTypeDeCoup(hs,4,hs.capacite1BonusSkill,degats,cible)
...
class HerosEpee(Monstre):
    def __init__(self):
        Monstre.__init__(self,'Héros de l Epée','aux Deux Lames',3,1,2250,2250,150,64,125)
        ...
        self.capacite1=HerosEpee.Entaille
    ...
    def Entaille(he,cible):
        print('\n',he.surnom,he.attribut,' tranche ',cible.surnom,cible.attribut,' avec son épée en ignorant sa défense!!\n')
        degats=CalculDommage(he,4,he.capacite1BonusSkill,cible)
        AffichageTypeDeCoup(he,4,he.capacite1BonusSkill,degats,cible)
        Procedure_attaque(he,degats,cible)
        return cible
...
class Base:
    ...
    def reset_monstre(nom_creature):
        ...
        if(nom_creature=='HerosBouclier' or nom_creature=='Héros du Bouclier'):
            creature=HerosBouclier()
        if(nom_creature=='HeroineSceptre' or nom_creature=='Héroïne du Sceptre'):
            creature=HeroineSceptre()
        if(nom_creature=='HerosEpee' or nom_creature=='Héros de l\'Epée'):
            creature=HerosEpee()
...
def RuinesSenzargen_Autel():
    ...
    while(monstre5.niveau!=13):
        monstre5=Donjon.Monter_en_niveau_sans_affichage(monstre5)
    monstre5.surnom='Haut Elementaire Vent 1'
    
    monstre6=HautElementaire()
    while(monstre6.attribut!='Vent'):
        monstre6=HautElementaire()
    while(monstre6.niveau!=13):
        monstre6=Donjon.Monter_en_niveau_sans_affichage(monstre6)
    monstre6.surnom='Haut Elementaire Vent 2'
...
if(choix==0):
    ...
    #allie1=Base.invoquerDefini(base,'HerosBouclier','la Destruction')
    allie1=Base.invoquerDefini(base,'HerosEpee','aux Deux Lames')
    allie2=0
    allie3=0
    allie1.surnom='Estark'
    '''
    ennemi1=Base.invoquerDefini(base,'Slime','Feu')
    ennemi1=Monstre.Evoluer(ennemi1)
    ennemi1=Monstre.Evoluer(ennemi1)
    #ennemi1=Monstre.Evoluer(ennemi1)
    ennemi2=Base.invoquerDefini(base,'Slime','Eau')
    ennemi2=Monstre.Evoluer(ennemi2)
    ennemi2=Monstre.Evoluer(ennemi2)
    ennemi3=Base.invoquerDefini(base,'Slime','Vent')
    ennemi3=Monstre.Evoluer(ennemi3)
    ennemi3=Monstre.Evoluer(ennemi3)
    '''
    ennemi1=Base.invoquerDefini(base,'HerosBouclier','la Destruction')
    ennemi1.surnom='Zero'
    ennemi2=0
    ennemi3=0
