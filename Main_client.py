...
if(choix == 1):
    ...
    partie = dictionnaire_recupere["partie"]
    equipe_1 = dictionnaire_recupere["equipe"]
    print("\n\n")
    print(equipe_1.membres[0])
    print('\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n')
    print("\n\n Vous entrez dans le mode multijoueur... \n\n")
    sac_tmp = Inventaire()
    game_tmp = Game(sac_tmp)
    print(" Je veux être client !! J'appelle combat multijoueur... ")
    equipe_1.combat_multijoueurs(game_tmp, 'client')
